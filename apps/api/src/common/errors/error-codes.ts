...
export const ErrorCode = {
  ...
  EMPLOYEE_TRAVEL_GAP_TOO_SHORT: 'EMPLOYEE_TRAVEL_GAP_TOO_SHORT',
  VEHICLE_DOUBLE_BOOKED: 'VEHICLE_DOUBLE_BOOKED',
  VEHICLE_TRAVEL_GAP_TOO_SHORT: 'VEHICLE_TRAVEL_GAP_TOO_SHORT',
   ...
   * goes over that number; a solve that moved work on to a full day would hand
   * the manager back the twenty-job day the cap exists to prevent.
   */
