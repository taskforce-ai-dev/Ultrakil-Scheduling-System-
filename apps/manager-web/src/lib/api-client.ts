 ...
 *
 * This boundary is intentionally a direct projection of the generated OpenAPI
 * contract. Pages may compose those returned fields for display, but must not
 * invent planner metadata that the server did not return.
 * ---------------------------------------------------------------------- */
...
>;
export type PublishedAssignmentRepairFinding = PublishedAssignmentRepairFindingsPage["items"][number];
...
export type PublishedAssignmentRepairOperation = components["schemas"]["PublishedAssignmentRepairOperationDto"];
...
export type BuildPublishedAssignmentRepairPlanRequest = components["schemas"]["PublishedAssignmentRepairPlanDto"];
export type ApplyPublishedAssignmentRepairRequest = components["schemas"]["PublishedAssignmentRepairApplyDto"];
